    ...
    return (
        <>
            ...
            <div className=''>
                ...
                <div className='h-10'></div>
                <div id="carousel" className="carousel w-full left-0 relative mt-[-6rem]">
                    <div id="slide1" className="carousel-item relative w-full">
                        <img src={Shoe} className="w-1/2 left-1/4 relative  pt-[-2.5rem] mt-20" />
                        <div className="absolute h-4 min-h-[1rem] flex justify-between transform -translate-y-1/2 left-0 right-0 top-[60%]">
